...
<form:form name="regist" commandName="regist" method="post" action="/backoffice/sub/operManage/xmlAuth.do">
				<input type="hidden"  name="xml" id="xml" value="${xml }" >
</form:form>				

<script type="text/javascript">
$(document).ready(function() {        
	$("form[name=regist]").attr("action", "/backoffice/sub/operManage/xmlAuth.do").submit();  
});    
