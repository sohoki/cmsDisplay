...
<form:form name="regist" commandName="regist" method="post" action="/backoffice/sub/operManage/jsonAuthJson.do">
				<input type="hidden"  name="json" id="json" value="${json}" >
</form:form>				

<script type="text/javascript">
$(document).ready(function() {        
	$("form[name=regist]").attr("action", "/backoffice/sub/operManage/jsonAuth.do").submit();  
});    
