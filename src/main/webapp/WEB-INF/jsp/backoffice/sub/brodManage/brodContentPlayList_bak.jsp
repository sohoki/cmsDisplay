...
<input type="hidden" name="atchFileId" id="atchFileId" >
							...
							<div class="groupCon whiteBox groupTable">
								<div class="innerBox">							
									<div class="searchBox">
                                        ...
                                        <a href='javascript:ContentProc(&#39;Del&#39;)' class='grayBtn'>삭제</a>
			                            <a href='javascript:ContentProc(&#39;Ins&#39;)' class='grayBtn'>등록</a>										
									</div>									
									<!--테이블시작-->
									<table id="rightInfo">
										<!--테이블상단-->
 ...
 <script type="text/javascript">
	 ...
	 function search_form(){
	 	$("form[name=regist]").attr("action", "/backoffice/sub/brodManage/brodContentPlayList.do").submit();
	 }
