...
<form:form name="regist" commandName="regist" method="post" action="/backoffice/sub/equiManage/dashboardState2.do">
			...
			<div class="main-content">				
				<div class="content">
					...
					<ul class="topMenu" >
						...
						<li class="active"><a href="/backoffice/sub/equiManage/dashboardState2.do" class="playContents">음원방송 모니터링</a></li>
						<div class="clear"></div>
					</ul>
					<!--//하단 콘텐츠-->
					<div class="con">
						...
						<div class="con_title whiteBox ">
							<h2><img src="../../img/playContentssmall.png"> 총 음원방송 모니터링현황입니다.</h2>
							<table>
								<tbody>
									<tr>
										<th>총단말 : </th>
										<td>${resultListBrod.didCnt }대</td>
										<th>장애 : </th>
										<td>0대</td>
										<th>오프라인 : </th>
										<td>${resultListBrod.offCnt }대</td>
									</tr>
								</tbody>
							</table>		
							<table>
...
function linkPage(pageNo) {
	...
	$("form[name=regist]").attr("action", "/backoffice/sub/equiManage/dashboardState2.do").submit();
 }
</script>
</body>
</html>