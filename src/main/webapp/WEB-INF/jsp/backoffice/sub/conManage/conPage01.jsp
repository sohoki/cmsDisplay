...
<body>
<div class="con">			
  <div class="tableBox editTable sizeTable" style='vertical-align:top; leftmargin:15px;'>								
		  ...
		  <tr>
		    ...
		    <td>
		       <select name="imageSlidtype" id="imageSlidtype">
		          ...
		          <option value="1" <c:if test="${regist.imageSlidtype == '1' }"> selected </c:if>>1번 Slide</option>
		          <option value="2" <c:if test="${regist.imageSlidtype == '2' }"> selected </c:if>>2번 Slide</option>
		       </select>
		    </td>    
		    <td>
