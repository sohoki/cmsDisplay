...
<div class="contents">
		...
		<div class="textT">
			<!--테이블시작-->
			    <form:form name="regist" commandName="regist" method="post" action="/backoffice/sub/brodManage/brodContentCopy.do">
			    ...
			    <table>
					...
					<tbody class="text_left">
						<tr>
							<th>콘텐츠명</th>
							<td>
							<form:input path="brodName" name="brodName" title="콘텐츠명" />
							</td>
						</tr>		
						<tr>
							<th>콘텐츠운영날짜</th>
						...
						<th>이벤트유무</th>
							<td>
							  <input type="radio" name="secGubun" value="SECGUBUN01" />일반스케줄
							  <input type="radio" name="secGubun" value="SECGUBUN02" />이벤트스케줄
							</td>
						<tr>						
					</tbody>
				</table>			
	...
	<script type="text/javascript">
		  ...
		  function contentCntCheck(){
			  apiExecute(
						"POST", 
						"/backoffice/sub/brodManage/brodContentCopyInsertCnt.do",
						{
		  ...
		  function check_form(){
			  if (any_empt_line_id("brodName", "콘텐츠명을 입력 하지 않았습니다.") == false) return;
			  ...
			  $("form[name=regist]").attr("action", "/backoffice/sub/brodManage/brodContentCopyInsert.do").submit();
		  }	 		  
	</script>
</body>
</html>