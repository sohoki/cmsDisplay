...
<div id="sidebar">
	<ul>
		...
		<li>
			<div>
				<a class="leftMenuTxt" href="/backoffice/sub/equiManage/didList.do">단말기관리</a>
				<a class="leftMenuImg" onclick="menuOpen('device')"><img class="leftMenuImg_device" src="/img/list_open_icon.png"/></a>
			</div>
		</li>
