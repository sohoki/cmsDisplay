...
public class BrodPlayExcelView extends AbstractExcelView{
	...
	protected void buildExcelDocument(Map<String, Object> model,
		...
		try{
			...
			setText(getCell(sheet, 2, 1), "지점명");
			setText(getCell(sheet, 2, 2), "재생일자");
			setText(getCell(sheet, 2, 3), "파일명");
			setText(getCell(sheet, 2, 4), "앨범");
			setText(getCell(sheet, 2, 5), "가수");
			setText(getCell(sheet, 2, 6), "음원재생카운트");
			...
			for (int i = 0; i < goods.size(); i++) {
				...
				setText(cell, goodsVO.getCenterNm());
