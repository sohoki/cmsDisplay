...
public class EgovCcmCmmnClCodeManageController {
	...
	public String insertCmmnClCode (@ModelAttribute("loginVO") LoginVO loginVO
        ...
        System.out.println( "getClCodeDc:" + cmmnClCode.getClCodeDc() );
        System.out.println( "getUseAt:" + cmmnClCode.getUseAt() );
    	...
    	cmmnClCode.setFrstRegisterId(loginVO.getMberId());
...
/** EgovPropertyService.sample */
	...
	public String updateCmmnClCode (@ModelAttribute("loginVO") LoginVO loginVO
    	...
    	if (sCmd.equals("")) {
    		...
    		cmmnClCode.setLastUpdusrId(loginVO.getMberId());
