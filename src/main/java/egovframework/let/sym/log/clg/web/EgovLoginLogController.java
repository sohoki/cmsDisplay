...
public class EgovLoginLogController {
	...
	public String selectLoginLogInf(@ModelAttribute("searchVO") LoginLogVO loginLog,
		...
		int totCnt = loginLogService.selectLoginLogManageListTotCnt_S(loginLog);

		model.addAttribute("resultList", loginLogService.selectLoginLogInf(loginLog));
	...
	public String selectLoginLog(@ModelAttribute("searchVO") LoginLog loginLog,
		...
		LoginLog vo = loginLogService.selectLoginLog(logId);
